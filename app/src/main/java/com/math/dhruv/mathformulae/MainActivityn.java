...
public class MainActivityn extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activityn);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_activityn, menu);
        return true;
    }
        ...
        public boolean onNavigationItemSelected(MenuItem item){
            ...
            if (id == R.id.nav_for) {
                ...
                page_intent.setClass(getApplicationContext(), MainActivity.class);
                startActivity(page_intent);
            }
            else if (id == R.id.nav_cal)
            {
                page_intent.setClass(getApplicationContext(), CalActivity.class);
                startActivity(page_intent);
            }
